...
var Accordion = /*#__PURE__*/function () {
  ...
  _createClass(Accordion, [{
    ...
    key: "_updateAccordionHeight",
    value: function _updateAccordionHeight() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   docsSlider: function() { return /* binding */ docsSlider; }
/* harmony export */ });
var sliderDocs = document.querySelector('[data-slider="docs"]');
var docsSlider = function docsSlider() {
  if (!sliderDocs) {
    return;
  }
  var swiper = new Swiper(sliderDocs, {
    slidesPerView: 3,
    autoHeight: true,
    // freeMode: true, 
    spaceBetween: 20,
    navigation: {
      nextEl: '.swiper-button-next.jaw-next',
      prevEl: '.swiper-button-prev.jaw-prev'
    },
    breakpoints: {
      300: {
        slidesPerView: 1
...
var HeaderAccordion = /*#__PURE__*/function () {
  function HeaderAccordion() {
    ...
    this._breakpointMedia = window.matchMedia('(max-width: 1150px)');
...
/***/ "./js/modules/init-contacts-slider.js":
/*!********************************************!*\
  !*** ./js/modules/init-contacts-slider.js ***!
  \********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initContactsSlider: function() { return /* binding */ initContactsSlider; }
/* harmony export */ });
var sliderContacts = document.querySelector('[data-slider="video"]');
var initContactsSlider = function initContactsSlider() {
  if (!sliderContacts) {
    return;
  }
  var swiper = new Swiper(sliderContacts, {
    slidesPerView: 'auto',
    // centeredSlides: true, 
    freeMode: true,
    spaceBetween: 16,
...
/***/ "./js/modules/init-delivery-slider.js":
/*!********************************************!*\
  !*** ./js/modules/init-delivery-slider.js ***!
  \********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initDeliverySlider: function() { return /* binding */ initDeliverySlider; }
/* harmony export */ });
var sliderDelivery = document.querySelector('[data-slider="delivery"]');
var initDeliverySlider = function initDeliverySlider() {
  if (!sliderDelivery) {
    return;
  }
  var swiper = new Swiper(sliderDelivery, {
    slidesPerView: 1,
    spaceBetween: 20,
    autoHeight: true,
    pagination: {
...
/***/ "./js/modules/init-grade-slider.js":
/*!*****************************************!*\
  !*** ./js/modules/init-grade-slider.js ***!
  \*****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initGradeSlider: function() { return /* binding */ initGradeSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="grade"]');
var swiper1 = null;
var initGradeSlider = function initGradeSlider() {
  if (!slider) return;
    ...
    if (window.innerWidth <= 1024) {
      if (!swiper1) {
        swiper1 = new Swiper(slider, {
          ...
          spaceBetween: 0,
          navigation: {
            nextEl: '.swiper-button-next.grade__next',
            prevEl: '.swiper-button-prev.grade__prev'
          }
        });
      }
    } else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initMarquee: function() { return /* binding */ initMarquee; }
/* harmony export */ });
var initMarquee = function initMarquee() {
  var marqueeContainer = document.querySelector('.marquee');
  var marqueeContent = document.querySelector('.marquee__content');
  if (marqueeContent) {
    var originalSlides = marqueeContent.innerHTML;
    marqueeContent.innerHTML += originalSlides.repeat(2);
    var duplicateSlides = function duplicateSlides() {
      marqueeContent.innerHTML += originalSlides;
      adjustAnimationDuration();
    };
    var adjustAnimationDuration = function adjustAnimationDuration() {
      var slides = marqueeContent.querySelectorAll('.marquee__slide');
      var totalWidth = Array.from(slides).reduce(function (acc, slide) {
        return acc + slide.offsetWidth;
      }, 0);
      marqueeContent.style.width = "".concat(totalWidth, "px");
      var animationDuration = totalWidth / 150;
      marqueeContent.style.animationDuration = "".concat(animationDuration, "s");
      marqueeContent.style.animation = "marquee ".concat(animationDuration, "s linear infinite");
    };
    adjustAnimationDuration();
    setInterval(duplicateSlides, 3000);
  }
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initMove: function() { return /* binding */ initMove; }
/* harmony export */ });
var tops = document.querySelectorAll('.catalog__top');
var bottoms = document.querySelectorAll('.catalog__bottom');
var originalPositions = Array.from(bottoms).map(function (bottom) {
  return bottom.parentNode;
});
var initMove = function initMove() {
  if (window.innerWidth <= 766) {
    tops.forEach(function (top, index) {
      var catalogInfo = top.querySelector('.catalog__info');
      var bottom = bottoms[index];
      if (bottom && catalogInfo !== bottom.parentNode) {
        catalogInfo.appendChild(bottom);
      }
    });
  } else {
    tops.forEach(function (top, index) {
      var bottom = bottoms[index];
      if (bottom && originalPositions[index] !== bottom.parentNode) {
        originalPositions[index].appendChild(bottom);
      }
    });
  }
};
...
/***/ "./js/modules/init-podcast-slider.js":
/*!*******************************************!*\
  !*** ./js/modules/init-podcast-slider.js ***!
  \*******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initPodcastSlider: function() { return /* binding */ initPodcastSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="podcast"]');
var initPodcastSlider = function initPodcastSlider() {
  if (!slider) {
    return;
  }
  var swiper = new Swiper(slider, {
...
var initRange = function initRange() {
  var rangeSlider = document.querySelector('.range-slider__input');
  var progress = document.querySelector('.range-slider__progress');
  var valueDisplay = document.querySelector('.range-slider__value');
  if (rangeSlider) {
    rangeSlider.addEventListener('input', function () {
      var value = this.value;
      progress.style.width = "".concat(value, "%");
      valueDisplay.textContent = "".concat(value, "%");
      valueDisplay.style.left = "".concat(value, "%");
    });
    var fileInput = document.getElementById('file-input');
    var previewContainer = document.querySelector('.file-upload__preview');
    var fileNameElement = document.querySelector('.file-upload__filename');
    var removeButton = document.querySelector('.file-upload__remove');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initRevSlider: function() { return /* binding */ initRevSlider; }
/* harmony export */ });
...
/***/ "./js/modules/init-story-slider.js":
/*!*****************************************!*\
  !*** ./js/modules/init-story-slider.js ***!
  \*****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initStorySlider: function() { return /* binding */ initStorySlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="story"]');
var initStorySlider = function initStorySlider() {
  if (!slider) {
    return;
  }
  var swiper = new Swiper(slider, {
    ...
    spaceBetween: 16,
    navigation: {
      nextEl: '.swiper-button-next.story__next',
      prevEl: '.swiper-button-prev.story__prev'
    }
  });
};
...
/***/ "./js/modules/init-trust-slider.js":
/*!*****************************************!*\
  !*** ./js/modules/init-trust-slider.js ***!
  \*****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initTrustSlider: function() { return /* binding */ initTrustSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="trust"]');
var initTrustSlider = function initTrustSlider() {
  if (!slider) {
    return;
  }
  var swiper = new Swiper(slider, {
...
/***/ "./js/modules/init-whrite-slider.js":
/*!******************************************!*\
  !*** ./js/modules/init-whrite-slider.js ***!
  \******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initWhriteSlider: function() { return /* binding */ initWhriteSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="whrite"]');
var initWhriteSlider = function initWhriteSlider() {
  if (!slider) {
    return;
  }
  var swiper = new Swiper(slider, {
...
/***/ "./js/modules/init-work-shop-slider.js":
/*!*********************************************!*\
  !*** ./js/modules/init-work-shop-slider.js ***!
  \*********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initWorkShopSlider: function() { return /* binding */ initWorkShopSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="workshop"]');
var swiper;
var initWorkShopSlider = function initWorkShopSlider() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   injurySlider: function() { return /* binding */ injurySlider; }
/* harmony export */ });
var sliderInjury = document.querySelector('[data-slider="injury"]');
var injurySlider = function injurySlider() {
  if (!sliderInjury) {
    return;
  }
  var swiper = new Swiper(sliderInjury, {
    slidesPerView: 2,
    // autoHeight: true,

    spaceBetween: 20,
    navigation: {
      nextEl: '.swiper-button-next.jaw-injury-next',
      prevEl: '.swiper-button-prev.jaw-injury-prev'
    },
    breakpoints: {
      300: {
        slidesPerView: 1
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   sliderFoto: function() { return /* binding */ sliderFoto; }
/* harmony export */ });
var fotoSlider = document.querySelector('[data-slider="foto"]');
var sliderFoto = function sliderFoto() {
  if (!fotoSlider) {
    return;
  }
  var swiper = new Swiper(fotoSlider, {
    slidesPerView: 4,
    // autoHeight: true,

    spaceBetween: 17,
    navigation: {
      nextEl: '.swiper-button-next.jaw-foto-next',
      prevEl: '.swiper-button-prev.jaw-foto-prev'
    },
    breakpoints: {
      300: {
        slidesPerView: 1
...
/* harmony import */ var _modules_init_marquee__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-marquee */ "./js/modules/init-marquee.js");
/* harmony import */ var _modules_init_move__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-move */ "./js/modules/init-move.js");
/* harmony import */ var _modules_init_work_shop_slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-work-shop-slider */ "./js/modules/init-work-shop-slider.js");
/* harmony import */ var _modules_init_delivery_slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-delivery-slider */ "./js/modules/init-delivery-slider.js");
/* harmony import */ var _modules_init_contacts_slider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-contacts-slider */ "./js/modules/init-contacts-slider.js");
/* harmony import */ var _modules_init_range__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-range */ "./js/modules/init-range.js");
/* harmony import */ var _modules_init_story_slider__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-story-slider */ "./js/modules/init-story-slider.js");
/* harmony import */ var _modules_init_podcast_slider__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/init-podcast-slider */ "./js/modules/init-podcast-slider.js");
/* harmony import */ var _modules_init_grade_slider__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/init-grade-slider */ "./js/modules/init-grade-slider.js");
/* harmony import */ var _modules_init_rev_slider__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/init-rev-slider */ "./js/modules/init-rev-slider.js");
/* harmony import */ var _modules_init_whrite_slider__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/init-whrite-slider */ "./js/modules/init-whrite-slider.js");
/* harmony import */ var _modules_init_trust_slider__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/init-trust-slider */ "./js/modules/init-trust-slider.js");
/* harmony import */ var _modules_docs_slider__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/docs-slider */ "./js/modules/docs-slider.js");
/* harmony import */ var _modules_slider_foto__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/slider-foto */ "./js/modules/slider-foto.js");
/* harmony import */ var _modules_injury_slider__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/injury-slider */ "./js/modules/injury-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_move__WEBPACK_IMPORTED_MODULE_9__.initMove)();
    (0,_modules_init_marquee__WEBPACK_IMPORTED_MODULE_8__.initMarquee)();
    (0,_modules_init_work_shop_slider__WEBPACK_IMPORTED_MODULE_10__.initWorkShopSlider)();
    (0,_modules_init_delivery_slider__WEBPACK_IMPORTED_MODULE_11__.initDeliverySlider)();
    (0,_modules_init_contacts_slider__WEBPACK_IMPORTED_MODULE_12__.initContactsSlider)();
    (0,_modules_init_range__WEBPACK_IMPORTED_MODULE_13__.initRange)();
    (0,_modules_init_story_slider__WEBPACK_IMPORTED_MODULE_14__.initStorySlider)();
    (0,_modules_init_podcast_slider__WEBPACK_IMPORTED_MODULE_15__.initPodcastSlider)();
    (0,_modules_init_grade_slider__WEBPACK_IMPORTED_MODULE_16__.initGradeSlider)();
    (0,_modules_init_rev_slider__WEBPACK_IMPORTED_MODULE_17__.initRevSlider)();
    (0,_modules_init_whrite_slider__WEBPACK_IMPORTED_MODULE_18__.initWhriteSlider)();
    (0,_modules_init_trust_slider__WEBPACK_IMPORTED_MODULE_19__.initTrustSlider)();
    (0,_modules_docs_slider__WEBPACK_IMPORTED_MODULE_20__.docsSlider)();
    (0,_modules_slider_foto__WEBPACK_IMPORTED_MODULE_21__.sliderFoto)();
    (0,_modules_injury_slider__WEBPACK_IMPORTED_MODULE_22__.injurySlider)();
  });
});
}();
/******/ })()
